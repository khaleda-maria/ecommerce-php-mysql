    ...
    <div class="container">
        <div class="callbacks_container">
            <ul class="rslides" id="slider">
                <li><img src="assets/front_end_assets/images/slider1.jpg" class="img-responsive" alt=""/></li>
                <li><img src="assets/front_end_assets/images/2.jpg" class="img-responsive" alt=""/></li>
                <li><img src="assets/front_end_assets/images/3.jpg" class="img-responsive" alt=""/></li>
            </ul>
        </div>
    </div> 
</div>
    ...
    <div class="container">
        ...
        <div class="grid_2">
            ...
            <div class="col-md-3 span_6">
                <div class="box_inner">
                    <img src="admin/<?php echo $product_info['product_image']; ?>" class="img-responsive" alt="" style="width: 300px; height: 350px;"/>
...
<div class="content_middle">
    <div class="container">
        ...
        <ul id="flexiselDemo3">
            <li><img src="assets/front_end_assets/images/n1.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                    <div class="ticket"> </div>
                </div></li>
            <li><img src="assets/front_end_assets/images/n2.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                    <div class="ticket"> </div>
                </div></li>
            <li><img src="assets/front_end_assets/images/n3.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                    <div class="ticket"> </div>
                </div></li>
            <li><img src="assets/front_end_assets/images/n4.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                    <div class="ticket"> </div>
                </div></li>
            <li><img src="assets/front_end_assets/images/n5.jpg"  class="img-responsive" /><div class="grid-flex"><h4>Contrary to popular </h4><p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
                    <div class="ticket"> </div>
                </div></li>
        </ul>
        ...
        <script type="text/javascript" src="assets/front_end_assets/js/jquery.flexisel.js"></script>
    </div>
</div>
<div class="container">
    <div class="content_middle_bottom">
        ...
        <div class="col-md-8">
            ...
            <div class="a-top">
                <div class="left-grid">
                    <img src="assets/front_end_assets/images/t4.jpg" class="img-responsive" alt=""/>
                </div>
            ...
            <div class="a-top">
                <div class="left-grid">
                    <img src="assets/front_end_assets/images/t5.jpg" class="img-responsive" alt=""/>
                </div>
                <div class="right-grid">
                    <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat</p>
            ...
            <div class="a-top">
                <div class="left-grid">
                    <img src="assets/front_end_assets/images/t6.jpg" class="img-responsive" alt=""/>
                </div>
                <div class="right-grid">
                    <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat</p>
            ...
            <div class="a-top">
                <div class="left-grid">
                    <img src="assets/front_end_assets/images/t7.jpg" class="img-responsive" alt=""/>
                </div>
                <div class="right-grid">
                    <h4><a href="#">Duis autem vel eum iriure dolor in hendrerit</a></h4>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat</p>
    ...
    <div class="content_bottom">
        <div class="col-md-3 span_1">
            ...
            <img src="assets/front_end_assets/images/t8.jpg" class="img-responsive" alt=""/>
        </div>
        <div class="col-md-3 span_1">
            <ul class="spinner">
                <i class="bubble"> </i>
