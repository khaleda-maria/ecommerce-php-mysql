 <?php
      ...
      $result=$obj_app->category_page_show($category_id);
...
<div class="container">
                ...
                <div class="col-md-9">
                    ...
                    <div class="span_2">
                        <?php while($cat_info=  mysqli_fetch_assoc($result)){;?>
                        <div class="col_1_of_single1 span_1_of_single1">
                            
                            <a href="product_details.php?product_id=<?php echo $cat_info['product_id']; ?>">
                                <img src="assets/<?php echo $cat_info['product_image']?>" class="img-responsive" alt="" style=" width: 250px; height: 300px"/>
                                <h3> <?php echo $cat_info['product_name'];?></h3>
                                <p><?php echo $cat_info['product_short_description']; ?></p>
                                <h4>BDT. <?php echo $cat_info['product_price']; ?></h4>
                            </a> 
