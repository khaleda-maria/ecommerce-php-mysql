        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="admin_master.php"><span>Metro</span></a>
            ...
            <div class="row-fluid">
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="add_category.php"><i class="icon-edit"></i><span class="hidden-tablet"> Add Category</span></a></li>
                            <li><a href="manage_category.php"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Category</span></a></li>
                            <li><a href="add_manufacturar.php"><i class="icon-edit""></i><span class="hidden-tablet"> Add Manufacturer</span></a></li>
                            <li><a href="manage_manufacturar.php"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Manufacturer</span></a></li>
                            <li><a href="product.php"><i class="icon-edit"></i><span class="hidden-tablet"> Add Product</span></a></li>
                ...
                <div id="content" class="span10">
                    ...
                    if (isset($pages)) {
                        ...
                        } else if ($pages == 'add_manufacturar') {
                            include './pages/manufacturar_content.php';
                        } else if ($pages == 'manufacturar_content') {
                            include './pages/manage_manufacturar_content.php';
                        } else if ($pages == 'manage_manufacturer') {
                            include './pages/manage_manufacturar_content.php';
                        } else if ($pages == 'edit_manufacturer') {
                            include './pages/edit_manufacturar_content.php';
                        } 
                        ...
                        else if ($pages == 'view_invoice') {
                            include './pages/view_invoice_content.php';
                        }
                        else if ($pages == 'download_invoice') {
