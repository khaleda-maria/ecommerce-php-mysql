                    ...
                    <div class="row-fluid sortable">
                        <div class="box span12">
                            <div class="box-header" data-original-title>
                                <h2><i class="halflings-icon edit"></i><span class="break"></span>Manufacturer Form</h2>
                                <div class="box-icon">
                                ...
                                <form class="form-horizontal" action="" method="post">
                                    <fieldset>
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-primary" name="save_btn">Save category</button>
